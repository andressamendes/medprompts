...
export const VirtualSpaceCDN: React.FC = () => {
  ...
  useEffect(() => {
    if (!phaserLoaded || !containerRef.current || !user) return;
      ...
      const config = {
        ...
        scene: {
          ...
          create: function(this: any) {
            ...
            // Player name
            this.add.text(400, 250, user?.name || 'Player', {
              fontSize: '16px',
              color: '#FFD700',
            ...
            // Level badge
            this.add.text(400, 270, `Level ${user?.level || 1}`, {
              fontSize: '12px',
              color: '#FFD700',
            ...
            // Room label
            this.add.text(20, 20, 'Virtual Space (CDN Version)', {
              fontSize: '20px',
              color: '#ffffff',
              backgroundColor: 'rgba(0, 0, 0, 0.7)',
              padding: { x: 10, y: 5 }
  ...
  return (
    <div className="fixed inset-0 bg-slate-950">
      ...
      <div className="fixed top-4 right-4 z-50 bg-slate-900/80 rounded-lg p-3 text-sm text-slate-300">
        <p className="font-semibold mb-1">Virtual Space (CDN Version)</p>
