...
/**
 * Página Biblioteca - Busca e referências de livros médicos
 */
export default function Library() {
  ...
  // Carregar livros ao selecionar categoria
  useEffect(() => {
    if (selectedCategory) {
    ...
    setFavorites((prev) => {
      ...
      if (newFavorites.has(bookId)) {
        ...
        toast({
          ...
          description: 'Livro removido da sua lista',
        });
      } else {
        newFavorites.add(bookId);
        toast({
          title: 'Adicionado aos favoritos',
          description: 'Livro salvo na sua lista',
        });
      }
      return newFavorites;
    });
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2 mb-2">
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    {favorites.has(book.id) ? 'Remover dos favoritos' : 'Adicionar aos favoritos'}
                                  </TooltipContent>
                                </Tooltip>
                              </div>
