const e=[{id:"1",title:"Flashcards Otimizados para Anki",description:"Crie 30 flashcards médicos de alto rendimento com princípios de ciência cognitiva",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Utilize mnemônicos sempre que forem naturais, pois aumentam a retenção em 30 a 40 por cento`,tags:["flashcards","Anki","memorização","spaced repetition"],academicLevel:"Todos os níveis",estimatedTime:25,recommendedAI:{primary:"ChatGPT",reason:"Excelente para gerar conteúdo estruturado com formatação precisa. Cria flashcards seguindo regras específicas e distribui tipos cognitivos conforme solicitado.",alternatives:["Gemini","Claude"]}},{id:"2",title:"Gerador Visual de Codificação Dupla",description:"Combine representações verbais e visuais para maximizar retenção",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• A descrição visual deve ser clara o suficiente para servir como guia de desenho`,tags:["codificação dupla","visual","neurociência cognitiva"],academicLevel:"Todos os níveis",estimatedTime:20,recommendedAI:{primary:"NotebookLM",reason:"Superior na criação de diagramas e sínteses visuais. Integra múltiplas fontes e gera representações multimodais complexas.",alternatives:["Perplexity","ChatGPT"]}},{id:"3",title:"Guia de Autoexplicação Ativa",description:"Conduza sessão estruturada de autoexplicação com perguntas progressivas",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Priorize sempre a qualidade da explicação, não a velocidade da resposta`,tags:["autoexplicação","metacognição","aprendizagem ativa"],academicLevel:"Todos os níveis",estimatedTime:30,recommendedAI:{primary:"ChatGPT",reason:"Ideal para diálogos socráticos interativos. Ajusta respostas dinamicamente e mantém conversação progressiva.",alternatives:["Claude"]}},{id:"4",title:"Gerador de Exemplos Concretos",description:"Transforme conceitos abstratos em exemplos concretos e vívidos",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Pense sempre em facilitar reconhecimento, não apenas memorização`,tags:["exemplos concretos","analogias","casos clínicos"],academicLevel:"1º-2º ano",estimatedTime:15,recommendedAI:{primary:"ChatGPT",reason:"Excelente em criar analogias criativas e casos clínicos realistas. Gera múltiplos níveis de abstração com facilidade.",alternatives:["Claude","Gemini"]}},{id:"5",title:"Mapeador de Integração de Conhecimento",description:"Integre novo conhecimento à base existente com conexões significativas",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Priorize qualidade das conexões, não quantidade`,tags:["integração","conhecimento prévio","aprendizagem significativa"],academicLevel:"Todos os níveis",estimatedTime:25,prerequisites:["Conhecimento prévio do sistema/área relacionada"],recommendedAI:{primary:"NotebookLM",reason:"Especialista em síntese de múltiplas fontes. Identifica conexões profundas entre conceitos de diferentes documentos.",alternatives:["Perplexity"]}},{id:"6",title:"Resumir Notas de Estudo",description:"Sintetize conteúdo denso em formato estruturado de alto rendimento",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Organize o texto para leitura rápida e revisão de última hora`,tags:["resumo","alto rendimento","residência médica"],academicLevel:"3º-4º ano",estimatedTime:20,recommendedAI:{primary:"NotebookLM",reason:"Melhor ferramenta para análise profunda de documentos pessoais. Cria resumos hierárquicos priorizando informações de alto rendimento.",alternatives:["Perplexity"]}},{id:"7",title:"Banco de Questões Estilo Residência",description:"Crie 10 questões no padrão de provas de residência com justificativas completas",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Pense sempre em como a questão apareceria em uma prova real de residência`,tags:["questões","residência médica","prova","banco de questões"],academicLevel:"3º-4º ano",estimatedTime:40,prerequisites:["Conhecimento do tema avaliado"],recommendedAI:{primary:"Perplexity",reason:"Acesso a questões reais atualizadas e padrões de provas recentes. Valida informações com citações confiáveis.",alternatives:["ChatGPT","Claude"]}},{id:"8",title:"Simulador de Caso Clínico Interativo",description:"Conduza simulação interativa de caso clínico com revelação progressiva",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Priorize cases que desenvolvam raciocínio diagnóstico, não memorização`,tags:["caso clínico","simulação","raciocínio clínico","interativo"],academicLevel:"Todos os níveis",estimatedTime:35,recommendedAI:{primary:"ChatGPT",reason:"Excelente em simulações interativas progressivas. Mantém contexto e ajusta feedback dinamicamente.",alternatives:["Claude"]}},{id:"9",title:"Protocolo de Revisão Espaçada",description:"Implemente sistema científico de revisões otimizado para retenção máxima",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Reforce que pular revisões compromete todo o sistema`,tags:["revisão espaçada","repetição","retenção","memória"],academicLevel:"Todos os níveis",estimatedTime:15,recommendedAI:{primary:"ChatGPT",reason:"Cria cronogramas personalizados e adaptativos. Gera planos estruturados com regras claras.",alternatives:["Gemini"]}},{id:"10",title:"Gerador de Mnemônicos Médicos",description:"Crie dispositivos mnemônicos eficazes para memorização duradoura",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Teste o mnemônico perguntando se é fácil de lembrar sem consultar`,tags:["mnemônicos","memorização","técnicas de memória"],academicLevel:"Todos os níveis",estimatedTime:10,recommendedAI:{primary:"ChatGPT",reason:"Criativo na geração de acrônimos e frases memoráveis. Equilibra criatividade com precisão.",alternatives:["Claude","Gemini"]}},{id:"11",title:"Assistente de Leitura Ativa",description:"Transforme leitura passiva em aprendizagem ativa guiada",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Use feedback para corrigir equívocos imediatamente`,tags:["leitura ativa","compreensão","síntese"],academicLevel:"Todos os níveis",estimatedTime:30,recommendedAI:{primary:"NotebookLM",reason:"Especialista em análise de documentos. Extrai ideias principais e gera perguntas de compreensão profundas.",alternatives:["ChatGPT"]}},{id:"12",title:"Corretor de Provas com Feedback Formativo",description:"Analise erros em questões com diagnóstico preciso de lacunas conceituais",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Sugira revisão apenas do conteúdo diretamente relacionado ao erro`,tags:["correção","feedback","análise de erros","questões"],academicLevel:"Todos os níveis",estimatedTime:10,prerequisites:["Questão completa com gabarito"],recommendedAI:{primary:"Claude",reason:"Excelente em análise detalhada de raciocínio. Identifica padrões de erro e fornece feedback construtivo profundo.",alternatives:["ChatGPT"]}},{id:"13",title:"Tutor Socrático de Raciocínio Clínico",description:"Desenvolva pensamento crítico médico por meio de perguntas guiadas",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Quando o estudante travar, forneça uma pequena pista na forma de pergunta`,tags:["método socrático","raciocínio clínico","pensamento crítico"],academicLevel:"Todos os níveis",estimatedTime:25,recommendedAI:{primary:"ChatGPT",reason:"Mantém diálogo socrático progressivo e adaptativo. Ajusta perguntas dinamicamente ao raciocínio do estudante.",alternatives:["Claude"]}},{id:"14",title:"Análise de Imagem Médica Guiada",description:"Aprenda interpretação sistemática de exames de imagem passo a passo",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Erros de sistematização são mais comuns que erros de reconhecimento`,tags:["imagem médica","radiologia","interpretação sistemática"],academicLevel:"3º-4º ano",estimatedTime:20,prerequisites:["Anatomia básica da região avaliada"],recommendedAI:{primary:"ChatGPT",reason:"Guia análise sistemática progressiva. Mantém checklist estruturado e adapta perguntas conforme respostas.",alternatives:["Claude"]}},{id:"15",title:"Preparador de Apresentação de Caso Clínico",description:"Estruture apresentação oral de caso clínico de forma profissional",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Sempre termine com raciocínio diagnóstico explícito`,tags:["apresentação","caso clínico","comunicação médica","round"],academicLevel:"3º-4º ano",estimatedTime:15,recommendedAI:{primary:"ChatGPT",reason:"Excelente em estruturar informações de forma hierárquica. Prioriza dados relevantes e elimina redundâncias.",alternatives:["Claude"]}},{id:"16",title:"Organizador de Rotina de Estudos Personalizada",description:"Crie cronograma semanal realista e sustentável alinhado aos seus objetivos",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Reavalie e ajuste semanalmente`,tags:["organização","rotina","cronograma","planejamento"],academicLevel:"Todos os níveis",estimatedTime:20,recommendedAI:{primary:"ChatGPT",reason:"Cria planos personalizados detalhados. Adapta cronogramas conforme restrições individuais.",alternatives:["Gemini"]}},{id:"17",title:"Gerador de Plano de Estudo para Provas",description:"Planeje preparação estratégica para avaliações com cronograma reverso",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Evite estudar conteúdo novo nos últimos 3 dias`,tags:["planejamento","prova","cronograma reverso","preparação"],academicLevel:"Todos os níveis",estimatedTime:25,recommendedAI:{primary:"ChatGPT",reason:"Calcula distribuição temporal otimizada. Cria planos reversos detalhados e personalizados.",alternatives:["Gemini"]}},{id:"18",title:"Assistente de Anotações Cornell",description:"Estruture anotações de aula com o método Cornell para revisão eficaz",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Método Cornell combina anotação ativa com revisão estruturada`,tags:["anotações","método Cornell","organização","revisão"],academicLevel:"Todos os níveis",estimatedTime:20,recommendedAI:{primary:"NotebookLM",reason:"Sintetiza conteúdo denso em estruturas hierárquicas. Extrai conceitos-chave e gera perguntas de revisão.",alternatives:["ChatGPT"]}},{id:"19",title:"Explicador de Conceitos para Leigos",description:"Simplifique conceitos médicos complexos mantendo precisão científica",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Priorize compreensão funcional sobre detalhes técnicos`,tags:["comunicação","linguagem simples","paciente","analogias"],academicLevel:"Todos os níveis",estimatedTime:10,recommendedAI:{primary:"ChatGPT",reason:"Excelente em criar analogias acessíveis e traduções para linguagem simples sem perder precisão.",alternatives:["Claude","Gemini"]}},{id:"20",title:"Preparador de Artigo Científico Estruturado",description:"Organize informações para escrita de artigo seguindo estrutura IMRAD",category:"estudos",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Seja objetivo e direto; evite linguagem rebuscada`,tags:["artigo científico","IMRAD","pesquisa","publicação"],academicLevel:"3º-4º ano",estimatedTime:30,prerequisites:["Dados de pesquisa disponíveis"],recommendedAI:{primary:"ChatGPT",reason:"Estrutura informações complexas em formato IMRAD. Organiza lógica científica com clareza.",alternatives:["Claude"]}},{id:"21",title:"Simulador de Discussão de Caso Multidisciplinar",description:"Simule discussão clínica envolvendo múltiplas especialidades médicas",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Discussão multidisciplinar reflete prática médica real`,tags:["multidisciplinar","discussão clínica","integração","especialidades"],academicLevel:"3º-4º ano",estimatedTime:25,prerequisites:["Conhecimento básico das especialidades envolvidas"],recommendedAI:{primary:"Claude",reason:"Excelente em simular múltiplas perspectivas simultaneamente. Equilibra visões de diferentes especialidades.",alternatives:["ChatGPT"]}},{id:"22",title:"Criador de Árvore de Decisão Clínica",description:"Construa fluxograma de decisão clínica baseado em evidências",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Fluxogramas funcionam melhor que textos longos em situações de pressão`,tags:["árvore de decisão","fluxograma","protocolo","decisão clínica"],academicLevel:"3º-4º ano",estimatedTime:20,recommendedAI:{primary:"ChatGPT",reason:"Constrói fluxogramas lógicos estruturados. Organiza decisões binárias em sequência clara.",alternatives:["Gemini"]}},{id:"23",title:"Analisador de EBM (Medicina Baseada em Evidências)",description:"Analise criticamente artigos científicos com framework PICO",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Prática baseada em evidências equilibra evidências, experiência e valores do paciente`,tags:["medicina baseada em evidências","PICO","análise crítica","artigos científicos"],academicLevel:"3º-4º ano",estimatedTime:30,prerequisites:["Artigo científico completo"],recommendedAI:{primary:"Perplexity",reason:"Acessa artigos científicos atualizados e valida informações com citações. Analisa metodologia com rigor acadêmico.",alternatives:["ChatGPT","Claude"]}},{id:"24",title:"Tradutor de Diretrizes Clínicas",description:"Converta guidelines extensos em protocolos práticos e objetivos",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Atualize sempre que houver nova versão da diretriz`,tags:["diretrizes","guidelines","protocolo","prática clínica"],academicLevel:"3º-4º ano",estimatedTime:25,prerequisites:["Acesso à diretriz completa"],recommendedAI:{primary:"Perplexity",reason:"Acessa diretrizes atualizadas online. Extrai recomendações principais com citações precisas.",alternatives:["NotebookLM","ChatGPT"]}},{id:"25",title:"Gerador de Checklist de Admissão/Alta",description:"Crie checklist sistemático para admissão ou alta hospitalar",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
...
• Checklist não substitui raciocínio clínico, previne omissões`,tags:["checklist","admissão","alta","segurança do paciente"],academicLevel:"3º-4º ano",estimatedTime:15,recommendedAI:{primary:"ChatGPT",reason:"Cria listas estruturadas e contextualizadas. Organiza itens em sequência lógica de execução.",alternatives:["Gemini"]}},{id:"26",title:"Construtor de Diagnóstico Diferencial Estruturado",description:"Organize hipóteses diagnósticas de forma sistemática e priorizada",category:"clinica",content:`**PAPEL DA IA (PERSONA – OBRIGATÓRIO)**
